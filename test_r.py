...
from MMFS.net.IRNet import IRmodel


class IRModel(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.net = IRmodel(decoder=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=int, default=5,help='0 for denoise, 1 for derain, 2 for dehaze, 3 for deblur, 4 for enhance, 5 for all-in-one (3), 6 for all-in-one (5)')
    ...
    ckpt_path = "ckpt3/" + testopt.ckpt_name
