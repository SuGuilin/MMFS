clc
clear all
easy = 0; %% easy=1 用于测试：EN, SF,SD,PSNR,MSE, MI, VIF, AG, CC, SCD, Qabf等指标； easy=0 用于测试：Nabf, SSIM, MS_SSIM, FMI_pixel, FMI_dct, FMI_w等指�?dataset = 'TNO'
row_name1 = 'row1';
row_data1 = 'row2';
...
fileFolder=fullfile('../Image/Source-Image/TNO/ir'); % 源图像A�?��文件�?此处�?Evaluation\Image\Source-Image\TNO\ir'
dirOutput=dir(fullfile(fileFolder,'*.*'));
fileNames = {dirOutput.name};
[m, num] = size(fileNames);   
ir_dir = fullfile('../Image/Source-Image/TNO/ir'); % 源图像A�?��文件�?此处�?Evaluation\Image\Source-Image\TNO\ir'
vi_dir = fullfile('../Image/Source-Image/TNO/vi'); % 源图像B�?��文件�?此处�?Evaluation\Image\Source-Image\TNO\vi'
Fused_dir = fullfile('../Image/1/'); % 融合结果�?��文件�?此处�?'Evaluation\Image\Algorithm\SeAFusion_TNO'
