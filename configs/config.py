...
C.decoder = 'MLPDecoder' # 'MambaDecoder'
...
C.num_workers = 16
C.train_scale_array = [0.5, 0.75, 1, 1.25, 1.5, 1.75] #None #
C.warm_up_epoch = 10
C.alpha = 1
C.gamma = 1
C.beta = 10
...
"""Store Config"""
C.checkpoint_start_epoch = 1#50
C.checkpoint_step = 1#5
...
C.log_dir = osp.abspath('log_final_correct_loss_per/log_mfnet/' + 'log_' + C.dataset_name + '_' + C.backbone + '_' + 'cromb_conmb_cvssdecoder')
